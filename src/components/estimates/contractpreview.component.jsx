...
export default function ContractPreview() {
  ...
  const handlePDF = (pdf) => {
    ...
    // try {
    //   const pdfDOM = await drawDOM(element, {
    //     paperSize: "A4",
    //   });
    //   console.log("pdfDOM:")
    //   const base64 = await exportPDF(pdfDOM);
    ...
    // }).then(data => {
    //   // setBase64(data)
    //   iframeRef.current.src = data
    //   console.log(data)
    // })

    // console.log("savedPDF: ", savedPDF);
    // const fileBase64 = await fileToBase64(pdf);
      ...
      {/* <button
        ...
        onClick={() => {
          if (pdfExportComponent.current) {
            // handlePDF(pdfExportComponent.current);
            console.log("export: ", pdfExportComponent.current);
              ...
              <div className="term-for-project mt-5">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    client may be charged an additional cost unless installed
                    not to manufacturer specs by _______________ employees.
                    (Example: Rock type is changed after installed on site and
                  ...
                  <li>
                    ...
                    the project up to 21 (Twenty-one) days before project start
                    date. If the project is cancelled after 21 days prior to the
                    start date, a fee may be charged.{" "}
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    for by client. ____________ will handle submitting the
                    permit and inspections, but the cost of admin and permit is
                    not included unless specified in contract.
                  </li>
                  <li>
                    1.25 Concrete shall attain a compressive strength of not
                    less than 4,000 pounds per square inch at the age of 30 days
                    April - October and age of 120 days November - March.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    to stone, and there may be slight height differences in the
                  ...
                  <li>
                    ...
                    billed at $65 per man hour, to return items will be charged
                    to the homeowner, unless returned by ______________ in the
                    case we have extra after project completion
                  </li>
                  <li>
                    2.5 If additional concrete is needed for a depth more than
                    4” or what's stated in contract, a fee of $150 per yard will
                    be applied.
                  </li>
                  <h5> Warranties:</h5>
                  <li>
                    ...
                    the homeowner's responsibility to maintain all living items
                    such as trees, shrubs, annuals, perennials, and grass as
                    well as any maintenance on hardscaping.
                  </li>
                  <li>
                    {" "}
                    3.12 ________________ will not be held liable for any
                    damages caused by natural forces (Cracked sprinklers, freeze
                    and thaw, erosion, animals or anything beyond our control)
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    cracking of pavers. The following items will not be covered
                    in this warranty: Self inflicted causes or natural causes
                    (Floods, fires, hurricanes, tornadoes etc). Warranty does
                    not cover settling if proper drainage isn't installed. Small
                    chips, polymeric sand and efflorescence is not warrantied.
                    If there is a manufacturer problem, the warranty will go
                    through the manufacturer directly. Pavers may have a height
                    difference from one paver to the other in amounts less then
                    ⅜”. This is not considered settling and is not warrantied.
                  </li>
                  <li>
                    3.16______________ offers a 3 year warranty after signing of
                    the contract on retaining wall installation services. This
                    warranty covers settling, cracking and manufacturing
                    ...
                    Efflorescence is not covered in retaining wall warranty. If
                    there is a manufacturer problem, warranty will go through
                    the manufacturer directly.
                  </li>
                  <li>
                    {" "}
                    3.17 Irrigation is covered in a 90 day warranty period after
                    signing of the project. This includes, manufacturing
                    ...
                    backflow preventers are not included in warranty. After the
                    90 day warranty period, it will be the homeowners
                    responsibility to maintain the irrigation. Too much water or
                    too little water is not covered in warranty and further
                    damage caused by irrigation is not covered.
                  </li>
                  <li>
                    {" "}
                    3.18 Plants, trees, shrubs and grasses are covered in a 90
                    day warranty period after installation of the project. This
                    ...
                    watering, and damage by homeowner or 3rd party source will
                    not be covered in warranty.
                  </li>
                  <li>
                  ...
                  <li>
                    3.25 No warranty work will be completed until final payment
                    is made on the initial contract and any change orders.
                  </li>
                  <h5> Payment:</h5>
                  <li>
                    {" "}
                  ...
                  <li>
                    ...
                    processing/ charging credit card client has ensured a final
                    walk-through has been conducted and is completely satisfied
                    with work performed/ project outcome/ completion and client
                    agrees there will make no charge-back attempts or
                    charge-backs processed. Instead of credit card charge back
                    attempts clients will utilize warranty provided by
                    _______________. If legal mitigation is needed for payment
                    (including credit card charge-backs), client accepts
                    responsibility for legal/ court/ lawyer fees/ penalties etc.
                    incurred by_____________ during legal proceedings plus
                    balance due.
                  </li>
                  <li>
                    4.16 If there are remaining items carried on for 2 weeks or
                    more past the date of which the project is over 80%
                  ...
                  <li>
                    ...
                    completion of the project. Final payment will still be made
                    if irrigation adjustments are required as that's considered
                    as maintenance
                  </li>
                  ...
                  <li>
                    ...
                    ___________________ and client to resolve the issue. Utility
                    line include but are not limited to: (Gas, electric,
                    comcast, cable, tela-communications, xcel, power, etc)
                  </li>
                  <li>
                    {" "}
                    ...
                    original contract. Examples include, but are not limited to;
                    boulders, large roots, construction footings, stumps,
                    utilities, groundwater springs, etc. Additional work will be
                    billed for these items if to occur
                  </li>
                  <li>
                    {" "}
                  ...
                  <li>
                    ...
                    accepts no responsibility or liability for incorrectly
                    marked property lines or errors in survey. If access through
                    a neighboring property is required, it is the responsibility
                    of the client to gain legal, written, or verbal
                    authorization to proceed.
                  </li>
                  <li>
                    {" "}
                    5.15 When providing concrete demo, price assumes concrete is
                    a standard 4” thick with rebar spaced no closer than 16” and
                    no greater in size than ½” rebar. Concrete demo price also
            ...
            <span
              ...
              onClick={() => {
                if (pdfExportComponent.current) {
                  // handlePDF(pdfExportComponent.current);
                  console.log("export: ", pdfExportComponent.current);
                  pdfExportComponent.current.save("Estimation.pdf");
                  modalShow();
                }
              }}
            >
